...
import edu.wm.cs.cs301.brukeamare.generation.BSPBranch;
import edu.wm.cs.cs301.brukeamare.generation.BSPLeaf;
import edu.wm.cs.cs301.brukeamare.generation.BSPNode;
import edu.wm.cs.cs301.brukeamare.generation.Floorplan;
import edu.wm.cs.cs301.brukeamare.generation.Wall;
...
public class FirstPersonView {
	 ...
	 * 
	 */
	public void draw(MazePanel1 panel, int x, int y, int walkStep, int ang, float percentToExit) {
		// obtain a Graphics2D object we can draw on
//s		MazePanel1 g = panel.getBufferGraphics() ;
//        // viewers draw on the buffer graphics
		...
		//gc.addFilledRectangle(x,y,10,10);
		gc.addSky(x,y,viewWidth, viewHeight);
		gc.commit();
	 ...
	 * @param MazePanel1 to draw on, must be not null
	 * @param percentToExit gives the distance to exit
	 */

	private void drawBackground(MazePanel1 MazePanel1, float percentToExit) {
		MazePanel1.addBackground(percentToExit);
	}
