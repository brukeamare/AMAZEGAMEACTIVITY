...
public class Map {
	 ...
	 */
	public void draw(MazePanel1 panel, int x, int y, int angle, int walkStep,
			boolean showMaze, boolean showSolution) {
		//MazePanel1 g = panel.getBufferGraphics() ;
	 ...
	 */
	private void drawMap(MazePanel1 g, int px, int py, int walkStep,
	 ...
	 */
	private void drawVerticalLine(MazePanel1 g, boolean showMaze, int x, int y, int startX, int startY) {
	 ...
	 * @param startY the y coordinate for drawing
	 */
	private void drawHorizontalLine(MazePanel1 g, boolean showMaze, int x, int y, int startX,
			int startY) {
	 ...
	 * @param viewDY is the current viewing direction, y coordinate
	 */
	private void drawCurrentLocation(MazePanel1 gc, int viewDX, int viewDY) {
	 ...
	 */
	private void drawArrow(MazePanel1 gc, int viewDX, int viewDY,
	 ...
	 */
	private void drawSolution(MazePanel1 gc, int offsetX, int offsetY, int px, int py) {
